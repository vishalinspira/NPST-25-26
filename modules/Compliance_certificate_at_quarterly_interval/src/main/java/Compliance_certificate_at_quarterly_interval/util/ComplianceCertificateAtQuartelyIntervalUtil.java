...
public class ComplianceCertificateAtQuartelyIntervalUtil {
	private static Log LOG = LogFactoryUtil.getLog(ComplianceCertificateAtQuartelyIntervalUtil.class); 
