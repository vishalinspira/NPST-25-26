...
public class ErmConstantValues {
	...
	public static Map<String, String> TIME_TYPE_MAP;
	...
	static {
		...
		TYPE_OF_RECTIFICATION_MAP.put("Transfer of Excess amount", "Transfer of Excess amount");
		...
		TIME_TYPE_MAP=new HashMap<String, String>();
		TIME_TYPE_MAP.put("Initial", "Initial");
		TIME_TYPE_MAP.put("Complete", "Complete");	
	}
}
