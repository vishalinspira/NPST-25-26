...
public class ErmInformationPortlet extends MVCPortlet {
	...
	@Override
		...
		renderRequest.setAttribute("ermUtil",ermUtil );
		renderRequest.setAttribute("ermInformationLocalService",ermInformationLocalService );
		renderRequest.setAttribute("ermBatchInformationLocalService",ermBatchInformationLocalService );
	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		if(isSameBatchType(ermIds)) {
			long batchNo=0;
			String batchType=ermInformationLocalService.getErmInformation(Long.valueOf(ermIds[0])).getBatchType();
		...
		for(String ermId:ermIds) {
			...
			ermInformation= ermInformationLocalService.getErmInformation(Long.valueOf(ermId));
