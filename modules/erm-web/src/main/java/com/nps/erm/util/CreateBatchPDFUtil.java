...
public class CreateBatchPDFUtil {
	 ...
	 * @return
	 */
	public  File createBatchPDF(long companyId,long userId,long batchInformationId) {
		try {
	 ...
	 * @return
	 */
	public  File createBatchPDFForOldBatchType(long companyId,long userId,ErmBatchInformation batchInformation,String craName) {
	 ...
	 * @return
	 */
	public  File createBatchPDFForNewBatchType(long companyId,long userId,ErmBatchInformation batchInformation,String craName){  
		File file=FileUtil.createTempFile("pdf");
		try  {  
	    PdfWriter writer = new PdfWriter(file);
	    PdfDocument pdfDoc= new PdfDocument(writer);
